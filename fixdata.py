...
# Data location 
data_path = current_directory+"/../../project_course_data/"

# Given dataset 
origin_file = "pilot3.txt"

# Converted data into CSV
csv_file = "pilot4.csv"

# import dataset as panda dataframe, skip last rows with text
df = pd.read_fwf(data_path + origin_file, nrows=100426)
...
def convert_bytes(value):
    multipliers = {'K': 1000, 'M': 1000000, 'G': 1000000000, 'T': 1e12, 'P': 1e15}
...
df.to_csv(data_path + csv_file, sep= "\t")
